...
$sql="select * from cadastrolivro where idLivro={$idLivro}";
$query= mysqli_query($con, $sql);
$cadastrolivro=mysqli_fetch_assoc($query);
?>
...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <form method ="POST"  action= "salvarlivroedit.php" enctype= "multipart/form-data"> 
